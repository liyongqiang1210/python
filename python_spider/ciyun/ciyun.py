...
importStopword(filename='text/love.txt')  
...
text = open(path.join(d, 'text/zhufuci.txt'),encoding ='utf-8').read()  
...
wc = WordCloud( font_path='font/MSYH.TTF',#设置字体  
...
word_cloud.to_file("image/love.png") #保存图片
# 保存图片  
# wc.to_file(path.join(d, "image/love.png"))  